...
const Country = () => {
    const [myCountry, setMyCountry] = useState("Select a Country...")
  ...
  return (
    <div className="flex flex-col justify-between items-start">
      <div>
        <p className="text-sm">Step 5/5</p>
      ...
      <form className="flex flex-col w-full">
        ...
        >
          ...
          <optgroup id="country-optgroup-Africa" label="Africa">
            ...
            <option value="CD" label=" Democratic Republic of Congo">
              Congo - Kinshasa
            </option>
            ...
            <option value="CG" label="Republic of the Congo">
              Congo - Brazzaville
            </option>
          ...
          <optgroup id="country-optgroup-Antartica" label="Antarctica">
